...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-md p-8 space-y-8 bg-neutral-800 border border-neutral-700 rounded-xl shadow-lg">
      {/* Logo */}
      ...
      <form className="mt-8 space-y-6" onSubmit={handleLogin}>
        ...
        <div>
          <button
            type="submit"
            disabled={loading}
            className={`w-full flex justify-center items-center px-4 py-2 rounded-lg transition ${
              loading ? 'bg-neutral-700 text-neutral-400 cursor-not-allowed' : 'bg-[#1D4E5F] text-white hover:bg-[#123040]'
            }`}
          >
            {loading ? (
              <>
